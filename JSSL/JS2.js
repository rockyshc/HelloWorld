...
function Stack(){
    ...
    this.pop = function(){
        return item.removeAt(0);
    };

    this.peek = function(){
        var head = item.getHead();
        return head.element;
    };
...
sampleStack.push("Node 1");
sampleStack.push("Node 2");
sampleStack.push("Node 3");
sampleStack.push("Node 4");
sampleStack.print();
console.log("Top node is: " + sampleStack.peek());
console.log("Pop node: " + sampleStack.pop());
console.log("Top node is: " + sampleStack.peek());
sampleStack.print();